...
<div class="wrap about-wrap">
	...
	<h1><?php
		...
		printf( __( 'Thank you for updating %1$s!', 'ymbeseo' ), 'YMBE SEO' );
		?></h1>

	<p class="about-text">
		YMBE SEO 2.3 helps you optimize your site showing you errors straight from Google Search Console, and pointing you at posts that need work.
	</p>
		...
		<div class="headline-feature">
			...
			<div class="feature-section">
				<div class="col">
					...
					<p>
						If you have <a target="_blank" href="https://yoast.com/wordpress/plugins/seo-premium/#utm_source=ymbeseo-config&utm_medium=textlink&utm_campaign=about-page">YMBE SEO Premium</a>, you'll even be able to fix those errors by redirecting the broken
				...
				<div class="col">
					<img class="aligncenter"
					     ...
					     alt="YMBE SEO Search Console integration screenshot"/>
				</div>
			</div>
		</div>
		...
		<div class="headline-feature">
			<div class="feature-section">
				...
				<div class="col">
					...
					<p>
						Don't know how to optimize your posts? Read our <a target="_blank" href="https://yoast.com/ebooks/content-seo/#utm_source=ymbeseo-config&utm_medium=textlink&utm_campaign=about-page">Content SEO eBook</a>!
					</p>
				</div>
			</div>
		</div>
			...
			<div class="feature-section">
				<div class="col">
					...
					<p>
						...
						panel for YMBE SEO breadcrumbs. Automagically.
					</p>
		...
		<div class="changelog feature-list finer-points">
			...
			<div class="feature-section col two-col">
				<div>
					...
					<h4>YMBE SEO now truly YMBE SEO</h4>
					</ul>
					<p>
						Everyone already did it, so we finally caved. The plugin formerly known as WordPress SEO by
						Yoast, will now officially be called YMBE SEO. for WordPress.
					</p>
				</div>
				...
				<div class="last-feature">
					...
					<p>
						...
						columns from YMBE SEO, you'll now only see one small column with the SEO score image.
					</p>
				</div>
				...
				<div class="last-feature">
					...
					<p>
						<?php
						/* translators: %1$s expands to YMBE SEO, %2$s and %3$s to the anchor tags to the translate.yoast.com link, %4$d to the number of translations, %5$d to the number of translations, */
						printf( __( '%1$s ships, at time of release, with %4$d translations, of which %5$d are complete. That\'s a huge improvement from last time, and we\'re improving every week. Join us at %2$stranslate.yoast.com%3$s!', 'ymbeseo' ), 'YMBE SEO', '<a target="_blank" href="https://translate.yoast.com/projects/ymbeseo">', '</a>', 32, 10 );
						?>
					</p>
				</div>
			</div>
	...
	<div id="credits" class="ymbeseotab">
		<p class="about-description">
			<?php
			/* translators: %1$s and %2$s expands to anchor tags, %3$s expands to YMBE SEO */
			printf( __( 'While most of the development team is at %1$sYoast%2$s in the Netherlands, %3$s is created by a worldwide team.', 'ymbeseo' ), '<a target="_blank" href="https://yoast.com/">', '</a>', 'YMBE SEO' );
			echo ' ';
		...
		?>
		<p>We're always grateful for patches from non-regular contributors, in YMBE SEO 2.2 and 2.3, patches from the following people made it in:</p>
		<ul class="ul-square">
			<?php
