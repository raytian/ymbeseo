...
class YMBESEO_Admin {
	...
	function add_action_link( $links, $file ) {
		...
		$premium_link = '<a href="https://yoast.com/wordpress/plugins/seo-premium/support/#utm_source=wordpress-seo-settings-link&amp;utm_medium=textlink&amp;utm_campaign=support-link">' . __( 'Premium Support', 'ymbeseo' ) . '</a>';
	...
	function grant_access() {
		_deprecated_function( __METHOD__, 'WPSEO 1.5.0', 'YMBESEO_Utils::grant_access()' );
	...
	function maybe_upgrade() {
		_deprecated_function( __METHOD__, 'WPSEO 1.5.0', 'YMBESEO_do_upgrade' );
		new YMBESEO_Upgrade();
	}
	...
	function clear_cache() {
		_deprecated_function( __METHOD__, 'WPSEO 1.5.0', 'YMBESEO_Utils::clear_cache()' );
	...
	function clear_rewrites() {
		_deprecated_function( __METHOD__, 'WPSEO 1.5.0', 'YMBESEO_Utils::clear_rewrites()' );
	 ...
	 *
	 * @deprecated 1.5.0
	 * @deprecated use YMBESEO_Option::register_setting() on each individual option
	 * @see        YMBESEO_Option::register_setting()
	 */
	function options_init() {
		_deprecated_function( __METHOD__, 'WPSEO 1.5.0', 'YMBESEO_Option::register_setting()' );
	}
