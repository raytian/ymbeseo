...
class YMBESEO_Plugin_Conflict extends Yoast_Plugin_Conflict {
	...
	public static function hook_check_for_plugin_conflicts( $plugin = false ) {
		...
		$plugin_sections = array(
			/* translators: %1$s expands to YMBE SEO, %2%s: 'Facebook' plugin name of possibly conflicting plugin with regard to creating OpenGraph output*/
			'open_graph'   => __( 'Both %1$s and %2$s create OpenGraph output, which might make Facebook, Twitter, LinkedIn and other social networks use the wrong texts and images when your pages are being shared.', 'ymbeseo' )
				...
				. sprintf( __( 'Configure %1$s\'s OpenGraph settings', 'ymbeseo' ), 'YMBE SEO' )
				. '</a>',
			/* translators: %1$s expands to YMBE SEO, %2$s: 'Google XML Sitemaps' plugin name of possibly conflicting plugin with regard to the creation of sitemaps*/
			'xml_sitemaps' => __( 'Both %1$s and %2$s can create XML sitemaps. Having two XML sitemaps is not beneficial for search engines, yet might slow down your site.', 'ymbeseo' )
				...
				/* translators: %1$s expands to YMBE SEO */
				. sprintf( __( 'Configure %1$s\'s XML Sitemap settings', 'ymbeseo' ), 'YMBE SEO' )
				. '</a>',
		);
