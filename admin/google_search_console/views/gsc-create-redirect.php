		...
		switch ( $view_type ) {
			case 'create' :
				...
				<div class='form-field form-required'>
					<label for='wpseo-current-url'><?php _e( 'Current URL:', 'ymbeseo' ); ?></label>
					<input type='text' id='wpseo-current-url' name='current_url' value='<?php echo $url; ?>' disabled='disabled'>
				</div>
				<div class='form-field form-required'>
					<label for='wpseo-new-url'><?php _e( 'New URL:', 'ymbeseo' ); ?></label>
					<input type='text' id='wpseo-new-url' name='new_url' autofocus value=''>
				</div>
				<div class='form-field form-required'>
					<label for='wpseo-mark-as-fixed' class='clear'><?php _e( 'Mark as fixed:', 'ymbeseo' ); ?></label>
