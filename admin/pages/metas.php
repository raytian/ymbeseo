			...
			<table class="form-table">
				<tr>
					...
					<td>
						...
						echo '<p class="description">', sprintf( __( '%1$s has auto-detected whether it needs to force rewrite the titles for your pages, if you think it\'s wrong and you know what you\'re doing, you can change the setting here.', 'ymbeseo' ), 'YMBE SEO' ) . '</p>';
						?>
					</td>
				</tr>
				<tr>
		...
		<div id="post_types" class="ymbeseotab">
			...
			if ( is_array( $post_types ) && $post_types !== array() ) {
				foreach ( $post_types as $pt ) {
					...
					/* translators: %1$s expands to YMBE SEO */
					$yform->checkbox( 'hideeditbox-' . $name, __( 'Hide', 'ymbeseo' ), sprintf( __( '%1$s Meta Box', 'ymbeseo' ), 'YMBE SEO' ) );
