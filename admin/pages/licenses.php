...
$extensions = array(
	'seo-premium'     => (object) array(
		...
		'title'     => 'YMBE SEO Premium',
		/* translators: %1$s expands to YMBE SEO */
		'desc'      => sprintf( __( 'The premium version of %1$s with more features & support.', 'ymbeseo' ), 'YMBE SEO' ),
		'installed' => false,
	),
	...
	'woocommerce-seo' => (object) array(
		...
		/* translators: %1$s expands to YMBE SEO */
		'desc'      => sprintf( __( 'Seamlessly integrate WooCommerce with %1$s and get extra features!', 'ymbeseo' ), 'YMBE SEO' ),
		'installed' => false,
	),
);
...
<div class="wrap ymbeseo_table_page">
	...
	<h2 id="ymbeseo-title"><?php
		/* translators: %1$s expands to YMBE SEO */
		printf( __( '%1$s Extensions', 'ymbeseo' ), 'YMBE SEO' );
		?></h2>
