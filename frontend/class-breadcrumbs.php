...
class YMBESEO_Breadcrumbs {
	...
	/**
	 * @var string    YMBE SEO breadcrumb separator
	 */
	private $separator = '';

	/**
	 * @var string    HTML wrapper element for the YMBE SEO breadcrumbs output
	 */
	...
	/**
	 * Filter: 'ymbeseo_breadcrumb_separator' - Allow (theme) developer to change the YMBE SEO breadcrumb separator.
	 *
	...
	/**
	 * Filter: 'ymbeseo_breadcrumb_output_wrapper' - Allow changing the HTML wrapper element for the YMBE SEO breadcrumbs output
	 *
	...
	private function get_post_ancestors() {
		...
		/**
		 * Filter: Allow changing the ancestors for the YMBE SEO breadcrumbs output
		 *
	...
	private function set_crumbs() {
		...
		/**
		 * Filter: 'ymbeseo_breadcrumb_links' - Allow the developer to filter the YMBE SEO breadcrumb links, add to them, change order, etc.
		 *
	...
	private function get_link_info_for_id( $id ) {
		...
		/**
		 * Filter: 'wp_seo_get_bc_title' - Allow developer to filter the YMBE SEO Breadcrumb title.
		 *
	...
	private function crumb_to_link( $link, $i ) {
		...
		/**
		 * Filter: 'ymbeseo_breadcrumb_single_link' - Allow changing of each link being put out by the YMBE SEO breadcrumbs class
		 *
	...
	private function wrap_breadcrumb() {
		if ( is_string( $this->output ) && $this->output !== '' ) {
			...
			/**
			 * Filter: 'ymbeseo_breadcrumb_output' - Allow changing the HTML output of the YMBE SEO breadcrumbs class
			 *
	...
	/**
	 * Filter: 'ymbeseo_breadcrumb_output_id' - Allow changing the HTML ID on the YMBE SEO breadcrumbs wrapper element
	 *
	...
	/**
	 * Filter: 'ymbeseo_breadcrumb_output_class' - Allow changing the HTML class on the YMBE SEO breadcrumbs wrapper element
	 *
