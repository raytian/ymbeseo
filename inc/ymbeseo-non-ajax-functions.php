...
function YMBESEO_import_aioseo_setting_notice() {
	$url = add_query_arg( array( '_wpnonce' => wp_create_nonce( 'wpseo-import' ) ), admin_url( 'admin.php?page=YMBESEO_tools&tool=import-export&import=1&importaioseo=1#top#import-seo' ) );
...
function YMBESEO_import_robots_meta_notice() {
	$url = add_query_arg( array( '_wpnonce' => wp_create_nonce( 'wpseo-import' ) ), admin_url( 'admin.php?page=YMBESEO_tools&tool=import-export&import=1&importrobotsmeta=1#top#import-other' ) );
