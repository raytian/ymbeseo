 ...
 * all YMBESEO options and subkeys within options.
 *
 * Some guidelines:
 * [Retrieving options]
...
// @codingStandardsIgnoreEnd
	...
	public static function sanitize_text_field( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::sanitize_text_field()' );
	...
	public static function sanitize_url( $value, $allowed_protocols = array( 'http', 'https' ) ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::sanitize_url()' );
	...
	public static function validate_bool( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::validate_bool()' );
	...
	public static function emulate_filter_bool( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::emulate_filter_bool()' );
	...
	public static function validate_int( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::validate_int()' );
	...
	public static function emulate_filter_int( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::emulate_filter_int()' );
	...
	public static function trim_recursive( $value ) {
		_deprecated_function( __FUNCTION__, 'YMBESEO 1.5.6.1', 'YMBESEO_Utils::trim_recursive()' );
