...
function YMBESEO_set_value( $meta_key, $meta_value, $post_id ) {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.5.0', 'YMBESEO_Meta::set_value()' );
...
function get_YMBESEO_options() {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.5.0', 'YMBESEO_Options::get_all()' );
...
function YMBESEO_strip_shortcode( $text ) {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.6.1', 'YMBESEO_Utils::strip_shortcode()' );
...
function YMBESEO_calc( $number1, $action, $number2, $round = false, $decimals = 0, $precision = 10 ) {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.6.1', 'YMBESEO_Utils::calc()' );
...
function YMBESEO_is_apache() {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.6.1', 'YMBESEO_Utils::is_apache()' );
...
function YMBESEO_standardize_whitespace( $string ) {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.6.1', 'YMBESEO_Utils::standardize_whitespace()' );
